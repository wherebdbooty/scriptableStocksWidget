...
let stockList	= "PHP=X,CL=F,NG=F,EURUSD=X,GBPUSD=X,JPY=X,BTC-USD,ETH-USD,DOGE-USD,LRC-USD,XRP-USD,AAPL,GOOG,TWTR,GME,NFLX,AMZN,TSLA,^DJI,^IXIC"
...
let bodySpacing = 10 //space between stock area and footer
